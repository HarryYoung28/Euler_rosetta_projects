...
for index, item in enumerate(long_number_list):
    ...
    result = (item * long_number_list[index + 1] * long_number_list[index + 2] * long_number_list[index + 3] *
              long_number_list[index + 4] * long_number_list[index + 5] * long_number_list[index + 6] *
              long_number_list[index + 7] * long_number_list[index + 8] * long_number_list[index + 9] *
              long_number_list[index + 10] * long_number_list[index + 11] * long_number_list[index + 12])
